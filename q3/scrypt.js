...
initBtn.addEventListener('click', () => {
    ...
    websocket.onmessage = function(event){
        ...
        //можно вынести за пределы обработчика, но тут большой разницы нет, т.к. мы используем тестовый сервер и он пришлет ответ только в случае если мы туда что то отправим
